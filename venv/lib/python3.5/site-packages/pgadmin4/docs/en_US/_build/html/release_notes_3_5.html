...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Version 3.5 &#8212; pgAdmin 4 3.6 documentation</title>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-0"><a href="index.html">pgAdmin 4 3.6 documentation</a> &#187;</li>
...
<p>This release contains a number of features and fixes reported since the release of pgAdmin4 3.4</p>
<div class="section" id="features">
<h2>Features<a class="headerlink" href="#features" title="Permalink to this headline">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/1253">Feature #1253</a> - Save the treeview state periodically, and restore it automatically when reconnecting.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3562">Feature #3562</a> - Migrate from Bootstrap 3 to Bootstrap 4.</div>
</div>
</div>
<div class="section" id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3232">Bug #3232</a> - Ensure that Utilities(Backup/Restore/Maintenence/Import-Export) should not be started if binary path is wrong and also added ‘Stop Process’ button to cancel the process.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3638">Bug #3638</a> - Fix syntax error when creating new pgAgent schedules with a start date/time and exception.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3674">Bug #3674</a> - Cleanup session files periodically.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3660">Bug #3660</a> - Rename the ‘SQL Editor’ section of the Preferences to ‘Query Tool’ as it applies to the whole tool, not just the editor.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3676">Bug #3676</a> - Fix CREATE Script functionality for EDB-Wrapped functions.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3700">Bug #3700</a> - Fix connection garbage collector.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3703">Bug #3703</a> - Purge connections from the cache on logout.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3722">Bug #3722</a> - Ensure that utility existence check should work for schema and other child objects while taking Backup/Restore.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3730">Bug #3730</a> - Fixed fatal error while launching the pgAdmin4 3.5. Update the version of the Flask to 0.12.4 for release.</div>
</div>
</div>
</div>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 3.5</a><ul>
