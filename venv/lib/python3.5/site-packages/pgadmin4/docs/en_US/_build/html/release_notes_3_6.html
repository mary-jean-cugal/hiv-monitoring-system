...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Version 3.6 &#8212; pgAdmin 4 3.6 documentation</title>
...
<p>This release contains a number of features and fixes reported since the release of pgAdmin4 3.5</p>
<div class="section" id="features">
<h2>Features<a class="headerlink" href="#features" title="Permalink to this headline">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/1513">Feature #1513</a> - Add support for dropping multiple objects at once from the collection Properties panel.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3772">Feature #3772</a> - Add the ability to import and export server definitions from a config database.</div>
</div>
</div>
<div class="section" id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3016">Bug #3016</a> - Ensure previous notices are not removed from the Messages tab in the Query Tool if an error occurs during query execution.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3029">Bug #3029</a> - Allow the selection order to be preserved in the Select2 control to fix column ordering in data Import/Export.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3629">Bug #3629</a> - Allow use of 0 (integer) and empty strings as parameters in the debugger.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3723">Bug #3723</a> - Properly report errors when debugging cannot be started.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3734">Bug #3734</a> - Prevent the debugger controls being pressed again before previous processing is complete.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3736">Bug #3736</a> - Fix toggle breakpoints buttons in the debugger.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3742">Bug #3742</a> - Fix changes to the NOT NULL and default value options in the Table Dialogue.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3746">Bug #3746</a> - Fix dropping of multiple functions/procedures at once.</div>
</div>
</div>
</div>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 3.6</a><ul>
